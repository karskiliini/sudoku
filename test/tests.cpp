...
TEST_F(SudokuTest, Test015) {
    ...
    string infile = string(ROOT_DIR) + "/test/ref/testcase.015_al_esgargot.input";
    string outfile = string(ROOT_DIR) + "/test/ref/testcase.015_al_esgargot.output";
